...
extension FLAnimatedImageView {
    ...
    func setImage(with url: URL?, placeholderImage: UIImage?) {
        DispatchQueue.global(qos: .userInteractive).async { [weak self] in
            ...
            strongSelf.sd_internalSetImage(with: url, placeholderImage: placeholderImage, options: SDWebImageOptions(rawValue: 0), operationKey: nil, setImageBlock: { [weak self] (image, imageData) in
